...
const skills = [
    ...
    {name : "DSA",level : 80, category : "Languages"}, 
...
const categories = ["all", "frontend", "backend", "tools", "Languages","Cloud"]; 
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
             ...
             {categories.map((category,key)=>(
                ...
                className={cn("px-5 py-2 rounded-full transition-colors duration-300 capitalize",
                    activeCategory === category? "bg-primary text-primary-foreground font-medium" : "bg-secondary/70 text-foreground hoverbg-secondary font-medium"
                )}>
                    {category}
                </button>
             ))}
